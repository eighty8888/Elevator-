...
// Code for elevator with existing people
//System.out.println("Enter the number of people in the elevator (at most " + Elevator.getPersonCapacity() + "): ");
//int listSize = input.nextInt();
//while(listSize > Elevator.getPersonCapacity()) {
//	System.out.println("Sorry! The elevator can only hold up to " + Elevator.getPersonCapacity() + " people. Enter the number of people in the elevator again: ");
//	listSize = input.nextInt();
//}
//input.nextLine();
//ArrayList<Person> people = new ArrayList<>();
//System.out.println("Keep in mind, the max weight the elevator can hold is " + Elevator.getWeightThreshold() + ": ");
...
//	int weight = input.nextInt();
//	input.nextLine();
//	while (weight + combinedWeight > Elevator.getWeightThreshold()) {
//		if (combinedWeight == Elevator.getWeightThreshold()) {
//			System.out.println("Sorry! You can't add any more people since the weight has already reached the maximum. "
//					+ "Do you want to remove the last person to make room for this person? Y/N");
//			response = input.next().charAt(0);
//			while (response != 'Y' && response != 'N') {
//				System.out.println("Invalid input. Try again. Do you want to remove the last person to make room for this person? Y/N");
//				response = input.next().charAt(0);
//			}
//			if (response == 'Y') {
//				combinedWeight -= people.get(i - 1).getWeight();
...
//		}
//		else {
//			System.out.println("Sorry! Having this person at this weight in the elevator would cause it to crash. Re-enter a different weight for this person:");
//			weight = input.nextInt();
//			input.nextLine();
//		}
//	}
//	combinedWeight += weight;
//	people.add(new Person(weight, name));
